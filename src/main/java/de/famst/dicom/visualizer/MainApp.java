...
public class MainApp extends PApplet
{
  ...
  public static void run(String fileName, String outputFolder)
  {
  ...
  public void settings()
  {
    ...
    picFileName = new File(outFolder, FilenameUtils.getBaseName(dcmFile.getAbsolutePath()) + ".jpg").getAbsolutePath();
  ...
  public void draw()
  {
    ...
    dicomParser.entries.forEach(e ->
    {
      ...
      if ((e.getTag() == Tag.Item) && multiFrameMode[0])
      {
        fill(hue, 0.0f, 0.0f);
        stroke(hue, 0.0f, 100.0f);
        rect(x, y, w, h);
